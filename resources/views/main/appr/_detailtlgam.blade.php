                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 404) {
                            ...
                            // document.getElementById("subtotal").innerHTML = idrFormat.format(sumprice);
                            // var tax = sumprice * 0.1;
                            // var shipping = sumprice * 0.05;
                            // document.getElementById("tax").innerHTML = idrFormat.format(tax);
                            // document.getElementById("shipping").innerHTML = idrFormat.format(shipping);
